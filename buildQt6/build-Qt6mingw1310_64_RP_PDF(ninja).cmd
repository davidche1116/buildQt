...
:: 设置MinGW版本代号
SET MinGW_VERSION=mingw1310_64_RP_PDF
...
SEt SRC_qtwebengine="%QT_PATH%\%QT_VERSION%\qtwebengine-everywhere-src-%QT_VERSION%"
...
::编译qtwebengine
mkdir build-qtwebengine
cd build-qtwebengine
cmake %SRC_qtwebengine%\CMakeLists.txt -G "Ninja" -DCMAKE_INSTALL_PREFIX=%INSTALL_DIR% -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH=%INSTALL_DIR%\lib\cmake"
cmake --build . --parallel
cmake --install .
cd ..
